...
<div id="headMenu">
	...
	<form>
		...
		<ul class="clearfix">
			...
			<li id="help"><a href="/mypage/help.html" class="popup">ヘルプ</a></li>

			<li id="user"><p id="hmName"><span><?=$loginData['karte']['name']?></span>さんのマイページ</p>

										<p id="conf"><a href="/mypage/customers/detail" class="popup">ご契約者様登録情報の確認と編集</a></p>
										<p id="conf"><a href="/mypage/customers/card" class="popup">カード情報の変更</a></p>
										</li>

			<li id="logout"><?=$this->Html->link($this->Html->image('common/btn_logout.png'),array('controller'=>'customers','action'=>'logout'),array('escape' => false))?></li>
...
<!--p class="banner01"><a href="http://anicli24.com/aboutanicli24/index.html" target="_blank"><img alt="バナー" src="/mypage/images/banner/banner01.jpg" width="915" height="116" class="over" /></a></p -->
