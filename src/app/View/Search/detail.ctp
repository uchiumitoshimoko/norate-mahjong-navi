...
?>
            ...
            <div class="module__page-breadcrumb">
                <div class="container "><a href="#">トップページ</a><a href="/search/joblist">求人検索</a><a href="#"><?=$company_name?> / <?=$jobs['Jobs']['title']?></a></div>
            </div>
...
?>
                                <h3 class="logo-image"><img src="/top_banners/read_image/<?=h($top_banners['TopBanners']['id']);?>">                               
                                </h3>
<?
		}
?>
...
?>
                                ...
                                <? if(!empty($top_banners)) { ?>
                                	<img src="/top_banners/read_image/<?=$top_banners['TopBanners']['id'];?>" alt="">
                                <? } ?>
<?
	}
?>
...
?>
                            ...
                            <div class="item-main">
                            <div>
                            	<div class="code">職種コード：<?=$syokusyu_name?></div>
                                ...
                                <div class="" style=" display: block;
                                        ...
                                        <a href="/entry/?jobid=<?=$jobs['Jobs']['id']?>">
                                            <img src="/img/02_entry_pc.jpg" style="max-width:100%; float:none; margin:0; display:inline;">
                                        </a>
