<?php $this->set('meta_description', '全国の健康麻雀・ノーレート麻雀のピックアップ店舗を紹介しています。毎回ランダムに表示されます。'); ?>
<div id="main">
...
<section class="rn-pref-section">
    ...
    <p class="rn-stores-note">※ピックアップのついているお店の中から、毎回ランダムに最大10件表示しています。</p>

    <?php if(empty($store_list)): ?>

    <div class="rn-results__empty">
        <p class="rn-results__empty-msg">現在ピックアップ店舗はありません。</p>
