 ...
 */
	...
	//Router::connect('/sp/', array('controller' => 'TopPages', 'action' => 'index'));
	...
	//Router::connect('/lp/:controller/');
	//Router::connect('/lp/:controller/', array('controller' => 'lp01', 'action' => 'index', 'lp'=>true));
